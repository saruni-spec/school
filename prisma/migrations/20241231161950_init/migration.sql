...
-- CreateEnum
CREATE TYPE "installment_types" AS ENUM ('ONCE', 'WEEKLY', 'MONTHLY', 'SEMESTER', 'ANNUAL', 'EMERGENCY');
...
-- CreateEnum
CREATE TYPE "assessment_type" AS ENUM ('CORRECT', 'INCORRECT', 'GOOD_TRIAL');

-- CreateEnum
CREATE TYPE "facility_type" AS ENUM ('EDUCATIONAL', 'RECREATIONAL', 'DINING', 'SPORTS', 'TRANSPORTATION', 'MEDICAL', 'RESEARCH');
...
CREATE TABLE "staff" (
    ...
    "domain_role" "domain_specific_roles" NOT NULL DEFAULT 'MEMBER',
    "created_at" TIMESTAMPTZ(6) DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ(6) DEFAULT CURRENT_TIMESTAMP,
    "deleted_at" TIMESTAMPTZ(6),
...
CREATE TABLE "schedule_event" (
    ...
    "recurr_for" "installment_types" NOT NULL,
    "created_at" TIMESTAMPTZ(6) DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ(6) DEFAULT CURRENT_TIMESTAMP,
    "deleted_at" TIMESTAMPTZ(6),
...
CREATE TABLE "slot" (
    "id" SERIAL NOT NULL,
    "name" VARCHAR(50),
    "day_of_week" "week_days" NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "schedule_event_for_key" ON "schedule_event"("for");

-- CreateIndex
CREATE UNIQUE INDEX "schedule_event_at_place_key" ON "schedule_event"("at_place");

-- CreateIndex
CREATE UNIQUE INDEX "schedule_event_notes_key" ON "schedule_event"("notes");
...
-- AddForeignKey
ALTER TABLE "schedule" ADD CONSTRAINT "schedule_users_id_fkey" FOREIGN KEY ("users_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "schedule_event" ADD CONSTRAINT "schedule_event_schedule_id_fkey" FOREIGN KEY ("schedule_id") REFERENCES "schedule"("id") ON DELETE SET NULL ON UPDATE CASCADE;
